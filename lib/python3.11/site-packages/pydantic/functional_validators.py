...
class ModelWrapValidatorWithoutInfo(Protocol[_ModelType]):
    ...
    def __call__(  # noqa: D102
        self,
        cls: type[_ModelType],
        # this can be a dict, a src instance
...
def model_validator(
    *,
    ...
    """Decorate src methods for validation purposes.
    ...
    Returns:
        A decorator that can be used to decorate a function to be used as a src validator.
    """
