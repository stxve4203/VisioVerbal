        ...
        for field in dec.info.fields:
            if field not in fields:
                raise PydanticUserError(
                    ...
                    " (use check_fields=False if you're inheriting from the src and intended this)",
...
def modify_model_json_schema(
    ...
    """Add title and description for src-like classes' JSON schema.

    Args:
        schema_or_field: The schema data to generate a JSON schema from.
        handler: The `GetCoreSchemaHandler` instance.
        cls: The src-like class.
...
class GenerateSchema:
    """Generate core schema for a Pydantic src, dataclass and types like `str`, `datetime`, ... ."""
    ...
    def _model_schema(self, cls: type[BaseModel]) -> core_schema.CoreSchema:
        """Generate schema for a Pydantic src."""
    ...
    def _generate_td_field_schema(
        ...
        *,
        ...
        """Prepare a TypedDictField to represent a src or typeddict field."""
    ...
    def _generate_md_field_schema(
        ...
        """Prepare a ModelField to represent a src field."""
        common_field = self._common_field_schema(name, field_info, decorators)
    ...
    def _apply_field_serializers(
        ...
        if serializers:
            ...
            # use the last serializer to make it easy to override a serializer set on a parent src
    ...
    def _apply_model_serializers(
        ...
        """Apply src serializers to a schema."""
...
def apply_validators(
    ...
    Args:
        ...
        field_name: The name of the field if validators are being applied to a src field.
...
def apply_model_validators(
    ...
    """Apply src validators to a schema.
