...
def create_generic_submodel(
    ...
    Args:
        model_name: The name of the newly created src.
        origin: The base class for the new src to inherit from.
...
def get_model_typevars_map(cls: type[BaseModel]) -> dict[TypeVarType, Any] | None:
    ...
    #   in the __origin__, __args__, and __parameters__ attributes of the src.
...
def check_parameters_count(cls: type[BaseModel], parameters: tuple[Any, ...]) -> None:
    """Check the generic src parameters count is equal.

    Args:
        cls: The generic src.
        parameters: A tuple of passed parameters to the generic src.

    Raises:
        TypeError: If the passed parameters count is not equal to generic src parameters count.
    """
