...
class ValidatorDecoratorInfo:
    ...
    Attributes:
        ...
        check_fields: Whether to check that the fields actually exist on the src.
    """
...
def inspect_validator(validator: Callable[..., Any], mode: FieldValidatorModes) -> bool:
    """Look at a field or src validator function and determine whether it takes an info argument.
...
def inspect_model_serializer(serializer: Callable[..., Any], mode: Literal['plain', 'wrap']) -> bool:
    """Look at a src serializer function and determine whether it takes an info argument.
    ...
    if isinstance(serializer, (staticmethod, classmethod)) or not is_instance_method_from_sig(serializer):
        raise PydanticUserError(
            '`@model_serializer` must be applied to instance methods', code='src-serializer-instance-method'
        )
