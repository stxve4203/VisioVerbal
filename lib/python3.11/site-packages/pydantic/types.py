...
if TYPE_CHECKING:
    ...
    class ImportString:
        ...
        On src instantiation, pointers will be evaluated and imported. There is
...
if TYPE_CHECKING:
    ...
    class Json:
        ...
        When you dump the src using `model_dump` or `model_dump_json`, the dumped value will be the result of validation,
...
class EncodedBytes:
    ...
    # Initialize the src with encoded data
...
# Initialize the src with base64 data
