    ...
    *fields: str,
    ...
    Args:
        ...
        *fields (str): Additional field(s) the validator should be called on.
        ...
        check_fields (bool | None, optional): Whether to check that the fields actually exist on the src.
            Defaults to None.
...
def root_validator(
    *__args,
    ...
    """Decorate methods on a src indicating that they should be used to validate (and perhaps
    modify) data either before or after standard src parsing/validation is performed.
