...
class FieldInfo(_repr.Representation):
    ...
    Attributes:
        ...
        exclude: Whether to exclude the field from the src serialization.
        ...
        repr: Whether to include the field in representation of the src.
    ...
    def get_default(self, *, call_default_factory: bool = False) -> Any:
        ...
        be called (namely, when instantiating a src via `model_construct`).
...
def Field(  # noqa: C901
    ...
    **extra: Unpack[_EmptyKwargs],
    ...
    Used to provide extra information about a field, either for the src schema or complex validation. Some arguments
...
def PrivateAttr(
    ...
    *,
    ...
    Private attributes are stored in `__private_attributes__` on the src.
...
def computed_field(
    ...
    *,
    ...
    Args:
        ...
        repr: whether to include this computed field in src repr.
