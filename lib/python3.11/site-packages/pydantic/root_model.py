...
class RootModel(BaseModel, typing.Generic[RootModelRootType]):
    ...
    A Pydantic `BaseModel` for the root object of the src.

    Attributes:
        root: The root object of the src.
        __pydantic_root_model__: Whether the src is a RootModel.
        __pydantic_private__: Private fields in the src.
        __pydantic_extra__: Extra fields in the src.
    ...
    def __init_subclass__(cls, **kwargs):
        ...
        if extra is not None:
            raise PydanticUserError(
                "`RootModel` does not support setting `model_config['extra']`", code='root-src-extra'
            )
    ...
    def model_construct(cls: type[Model], root: RootModelRootType, _fields_set: set[str] | None = None) -> Model:
        """Create a new src using the provided root object and update fields set.
        ...
        Raises:
            NotImplemented: If the src is not a subclass of `RootModel`.
        """
