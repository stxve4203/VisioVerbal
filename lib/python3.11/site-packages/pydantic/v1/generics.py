...
# E.g., for generic src `Model[A, B]`, when parametrized src `Model[int, str]` is created,
...
class GenericModel(BaseModel):
    ...
    def __class_getitem__(cls: Type[GenericModelT], params: Union[Type[Any], Tuple[Type[Any], ...]]) -> Type[Any]:
        ...
        :return: New src class inheriting from `cls` with instantiated
        ...
        if cls.__concrete__ and Generic not in cls.__bases__:
            raise TypeError('Cannot parameterize a concrete instantiation of a generic src')
        ...
        # Create new src with original src as parent inserting fields with DeferredType.
        ...
        # Find any typevars that are still present in the src.
        # If none are left, the src is fully "concrete", otherwise the new
        ...
        # Save created src in cache so we don't end up creating duplicate
    ...
    def __parameterized_bases__(cls, typevars_map: Parametrization) -> Iterator[Type[Any]]:
        ...
        :param typevars_map: Dictionary of type applications for binding subclasses.
            ...
            and a concrete src `Model[str, int]`,
        ...
        for base_model in cls.__bases__:
            if not issubclass(base_model, GenericModel):
                ...
                # can construct the Parameterised base src using typevars_map directly
