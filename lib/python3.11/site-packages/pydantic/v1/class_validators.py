...
def validator(
    *fields: str,
    ...
    :param check_fields: whether to check that the fields actually exist on the src
...
def root_validator(
    ...
    """
    Decorate methods on a src indicating that they should be used to validate (and perhaps modify) data either
    before or after standard src parsing/validation is performed.
    """
    if _func:
    ...
    def check_for_unused(self) -> None:
        ...
        if unused_validators:
            ...
            raise ConfigError(
                ...
                f"(use check_fields=False if you're inheriting from the src and intended this)"
            )
