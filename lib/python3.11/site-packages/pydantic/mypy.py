...
class PydanticModelTransformer:
    ...
    def transform(self) -> bool:
        ...
        * determines the src config and fields,
    ...
    def collect_fields(self, model_config: ModelConfigData) -> list[PydanticModelField] | None:
        """Collects the fields for the src, accounting for parent classes."""
        cls = self._cls
    ...
    def collect_field_from_stmt(  # noqa C901
        ...
        """Get pydantic src field from statement.

        Args:
            stmt: The statement.
            model_config: Configuration settings for the src.

        Returns:
            A pydantic src field if it could find the field in statement. Otherwise, `None`.
        """
        cls = self._cls
    ...
    def is_dynamic_alias_present(fields: list[PydanticModelField], has_alias_generator: bool) -> bool:
        """Returns whether any fields on the src have a "dynamic alias", i.e., an alias that cannot be
...
class ModelConfigData:
    """Pydantic mypy plugin src config class."""
    ...
    def get_values_dict(self) -> dict[str, Any]:
        """Returns a dict of Pydantic src config names to their values.
    ...
    def update(self, config: ModelConfigData | None) -> None:
        """Update Pydantic src config values."""
        if config is None:
            return
    ...
    def setdefault(self, key: str, value: Any) -> None:
        """Set default value for Pydantic src config if config value is `None`."""
...
def error_from_attributes(model_name: str, api: CheckerPluginInterface, context: Context) -> None:
    """Emits an error when the src does not have `from_attributes=True`."""
...
def error_untyped_fields(api: SemanticAnalyzerPluginInterface, context: Context) -> None:
    """Emits an error when there is an untyped field in the src."""
