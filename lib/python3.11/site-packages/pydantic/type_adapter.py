...
class TypeAdapter(Generic[T]):
    ...
    def validate_python(
        ...
        *,
        ...
        """Validate a Python object against the src.

        Args:
            __object: The Python object to validate against the src.
    ...
    def validate_json(
        ...
        """Validate a JSON string or bytes against the src.

        Args:
            __data: The JSON data to validate against the src.
            strict: Whether to strictly check types.
    ...
    def validate_strings(self, __obj: Any, *, strict: bool | None = None, context: dict[str, Any] | None = None) -> T:
        """Validate object contains string data against the src.
    ...
    def json_schema(
        ...
        *,
        ...
        Returns:
            The JSON schema for the src as a dictionary.
        """
