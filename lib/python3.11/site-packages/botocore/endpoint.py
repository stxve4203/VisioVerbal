...
def convert_to_response_dict(http_response, operation_model):
    ...
    :type http_response: botocore.vendored.requests.src.Response
...
class Endpoint:
    ...
    def _do_get_response(self, request, operation_model, context):
        ...
        # they currently have no reference to the operation or service src
        # The parsers should probably take the operation src instead of
