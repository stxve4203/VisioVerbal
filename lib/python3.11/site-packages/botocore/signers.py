...
class RequestSigner:
    ...
    * before-sign: Allows mutating the request before signing.
    ...
    :type service_id: botocore.src.ServiceId
...
def generate_presigned_url(
    ...
    :param HttpMethod: The http method to use on the generated url. By
        default, the http method is whatever is used in the method's src.
...
def generate_presigned_post(
    ...
    # We choose the CreateBucket operation src because its url gets
