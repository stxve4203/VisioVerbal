...
These classes essentially take user input, a src object that
...
class Serializer:
    ...
    def serialize_to_request(self, parameters, operation_model):
        ...
        src and serializes the parameters to an HTTP request.
...
class EC2Serializer(QuerySerializer):
    ...
    The EC2 src is almost, but not exactly, similar to the query protocol
    serializer.  This class encapsulates those differences.  The src
