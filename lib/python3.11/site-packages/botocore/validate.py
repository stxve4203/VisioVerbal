...
class ParamValidator:
    """Validates parameters against a shape src."""

    def validate(self, params, shape):
        """Validate parameters against a shape src.

        This method will validate the parameters against a provided shape src.
        ...
        :param shape: A shape src describing the expected input.
