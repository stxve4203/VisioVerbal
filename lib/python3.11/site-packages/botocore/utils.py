...
EVENT_ALIASES = {
    ...
    "lex-models": "lex-src-building-service",
    ...
    "mgh": "migration-hub",
    "models.lex": "lex-src-building-service",
...
class ArgumentGenerator:
    """Generate sample input based on a shape src.

    This class contains a ``generate_skeleton`` method that will take
    an input/output shape (created from ``botocore.src``) and generate
...
# src data directory name. The keys are the data directory name and the
