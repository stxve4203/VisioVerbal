...
class Shape:
    """Object representing a shape from the service src."""
    ...
    def __init__(self, shape_name, shape_model, shape_resolver=None):
        ...
        :param shape_model: The shape src.  This would be the value
            associated with the key in the "shapes" dict of the
            service src (i.e ``src['shapes'][shape_name]``)
...
class ServiceModel:
    ...
    def __init__(self, service_description, service_name=None):
        ...
        :param service_description: The service description src.  This value
            is obtained from a botocore.loader.Loader, or from directly loading
            the file yourself::

                service_description = json.load(
                    open('/path/to/service-description-src.json'))
                src = ServiceModel(service_description)
        ...
        :param service_name: The name of the service.  Normally this is
            ...
            it will default to the endpointPrefix defined in the src.
    ...
    def service_name(self):
        ...
        This defaults to the endpointPrefix defined in the service src.
        ...
        service src, then an ``UndefinedModelAttributeError`` exception
        will be raised.
    ...
    def signing_name(self):
        ...
        If the src does not define a signing name, this
        value will be the endpoint prefix defined in the src.
        """
    ...
    def _get_metadata_property(self, name):
        try:
            ...
            raise UndefinedModelAttributeError(
                f'"{name}" not defined in the metadata of the src: {self}'
            )
...
class OperationModel:
    def __init__(self, operation_model, service_model, name=None):
        ...
        :param operation_model: The operation src.  This comes from the
            service src, and is the value associated with the operation
            name in the service src (i.e ``src['operations'][op_name]``).

        :type service_model: botocore.model.ServiceModel
        :param service_model: The service src associated with the operation.

        :type name: string
        :param name: The operation name.  This is the operation name exposed to
            the users of this src.  This can potentially be different from
        ...
        if len(shape_ref) == 1 and 'shape' in shape_ref:
            ...
            try:
                ...
                raise InvalidShapeReferenceError(
                    f"Invalid src, missing shape reference: {shape_ref}"
                )
...
class DenormalizedStructureBuilder:
    """Build a StructureShape from a denormalized src.

    This is a convenience builder class that makes it easy to construct
    ``StructureShape``s based on a denormalized src.
    ...
    Example usage::
        ...
        # ``shape`` is now an instance of botocore.src.StructureShape
    ...
    def build_model(self):
        """Build the src based on the provided members.
