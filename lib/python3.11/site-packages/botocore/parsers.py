...
class ResponseParser:
    ...
    This class will take an HTTP response and a src shape and parse the
    ...
    def parse(self, response, shape):
        ...
        :param shape: The src shape describing the expected output.
        :return: Returns a dictionary representing the parsed response
            described by the src.  In addition to the shape described from
            the src, each response will also have a ``ResponseMetadata``
