...
class SharedExampleDocumenter:
    def document_shared_example(
        ...
        :param example: The src of the example

        :param prefix: The prefix to use in the method example.

        :param section: The section to write to.

        :param operation_model: The src of the operation used in the example
        """
...
def document_shared_examples(
    ...
    :param operation_model: The src of the operation.

    :param example_prefix: The prefix to use in the method example.

    :param shared_examples: The shared JSON examples from the src.
    """
