...
def py_type_name(type_name):
    """Get the Python type name for a given src type.
...
def py_default(type_name):
    """Get the Python default value for a given src type.
...
def get_official_service_name(service_model):
    ...
    :param service_model: The service src representing the service
    """
...
class DocumentedShape(_DocumentedShape):
    """Use this class to inject new shapes into a src for documentation"""
