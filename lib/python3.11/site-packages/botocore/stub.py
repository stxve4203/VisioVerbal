...
class Stubber:
    ...
    **Example:**
    ...
    def add_response(self, method, service_response, expected_params=None):
        ...
        against the service src to ensure correctness. It should be noted,
        ...
        :param service_response: A dict response stub. Provided parameters will
            be validated against the service src.
    ...
    def add_client_error(
        ...
        # We don't look to the src to build this because the caller would
