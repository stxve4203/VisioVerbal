...
# VegaLite spec, after the Data src has been put into a schema compliant
# form.
# ==============================================================================
...
class MaxRowsError(Exception):
    """Raised when a data src has too many rows."""
...
def limit_rows(data: _TDataType, max_rows: Optional[int] = 5000) -> _TDataType:
    """Raise MaxRowsError if the data src has more than max_rows.
...
def sample(
    ...
    """Reduce the size of the data src by sampling without replacement."""
    check_data_type(data)
...
def to_json(
    ...
    """
    Write the data src to a .json file and return a url based data src.
    """
...
def to_csv(
    ...
    """Write the data src to a .csv file and return a url based data src."""
...
def to_values(data: _DataType) -> _ToValuesReturnType:
    """Replace a DataFrame by a data src with values."""
    check_data_type(data)
    if hasattr(data, "__geo_interface__"):
        if isinstance(data, pd.DataFrame):
