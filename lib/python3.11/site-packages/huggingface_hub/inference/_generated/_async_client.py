...
class AsyncInferenceClient:
    ...
    async def table_question_answering(
        ...
        >>> await client.table_question_answering(table, query, src="google/tapas-base-finetuned-wtq")
    ...
    async def tabular_classification(self, table: Dict[str, Any], *, model: str) -> List[str]:
        ...
        ... }
        >>> await client.tabular_classification(table=table, src="julien-c/wine-quality")
        ["5", "5", "5"]
        ```
        """
    ...
    async def tabular_regression(self, table: Dict[str, Any], *, model: str) -> List[float]:
        ...
        ... }
        >>> await client.tabular_regression(table, src="scikit-learn/Fish-Weight")
        [110, 120, 130]
        ```
        """
    ...
    async def text_generation(
        ...
        *,
        ...
        try:
            ...
            if e.code == 400 and "The following `model_kwargs` are not used by the src" in error_message:
    ...
    async def translation(self, text: str, *, model: Optional[str] = None) -> str:
        ...
        >>> await client.translation("My name is Wolfgang and I live in Berlin", src="Helsinki-NLP/opus-mt-en-fr")
    ...
    async def zero_shot_classification(
        ...
        >>> client = AsyncInferenceClient()
        >>> text = (
        ...     "A new src offers an explanation async for how the Galilean satellites formed around the solar system's"
