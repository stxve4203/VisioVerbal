...
class ClassificationOutput(TypedDict):
    ...
    Args:
        label (`str`):
            The label predicted by the src.
        score (`float`):
            The score of the label predicted by the src.
    """
...
class ConversationalOutputConversation(TypedDict):
    ...
    Args:
        generated_responses (`List[str]`):
            A list of the responses from the src.
...
class ConversationalOutput(TypedDict):
    ...
    Args:
        generated_text (`str`):
            The last response from the src.
...
class FillMaskOutput(TypedDict):
    ...
    Args:
        ...
        sequence (`str`):
            The actual sequence of tokens that ran against the src (may contain special tokens).
    """
...
class ImageSegmentationOutput(TypedDict):
    ...
    Args:
        ...
        mask (`Image`):
            An Image object representing the mask predicted by the src.
        score (`float`):
...
class TokenClassificationOutput(TypedDict):
    ...
    Args:
        entity_group (`str`):
            The type for the entity being recognized (src specific).
        score (`float`):
            The score of the label predicted by the src.
        word (`str`):
