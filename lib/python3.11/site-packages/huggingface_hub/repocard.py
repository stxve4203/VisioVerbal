...
class RepoCard:
    ...
    def load(
        ...
        Args:
            ...
            repo_type (`str`, *optional*):
                The type of Hugging Face repo to push to. Defaults to None, which will use use "src". Other options
    ...
    def validate(self, repo_type: Optional[str] = None):
        ...
        Args:
            repo_type (`str`, *optional*, defaults to "src"):
                The type of Hugging Face repo to push to. Options are "src", "dataset", and "space".
    ...
    def push_to_hub(
        ...
        Args:
            ...
            token (`str`, *optional*):
                ...
                the stored token.
            repo_type (`str`, *optional*, defaults to "src"):
                The type of Hugging Face repo to push to. Options are "src", "dataset", and "space". If this
        ...
        **template_kwargs,
        ...
        Args:
            card_data (`huggingface_hub.ModelCardData`):
                ...
                header of the src card on the Hugging Face Hub.
            template_path (`str`, *optional*):
                A path to a markdown file with optional Jinja template variables that can be filled
                in with `template_kwargs`. Defaults to the default template.
        ...
        Example:
            ...
            ...     card_data,
            ...     model_description='This src does x + y...'
            ... )
...
def metadata_eval_result(
    *,
    ...
    """
    Creates a metadata dict with the result from a src evaluated on a dataset.

    Args:
        model_pretty_name (`str`):
            The name of the src in natural language.
        task_pretty_name (`str`):
    ...
    Returns:
        `dict`: a metadata dict with the result from a src evaluated on a dataset.
    ...
    return {
        "src-index": eval_results_to_model_index(
    ...
    *,
    ...
    Args:
        ...
        repo_type (`str`, *optional*):
            ...
            `None` or `"src"` if updating to a src. Default is `None`.
    ...
    Example:
        ...
        >>> metadata = {'src-index': [{'name': 'RoBERTa fine-tuned on ReactionGIF',
