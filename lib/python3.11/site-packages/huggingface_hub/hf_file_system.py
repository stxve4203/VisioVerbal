...
class HfFileSystem(fsspec.AbstractFileSystem):
    ...
    >>> # List files
    >>> fs.glob("my-username/my-src/*.bin")
    ['my-username/my-src/pytorch_model.bin']
    >>> fs.ls("datasets/my-username/my-dataset", detail=False)
    ['datasets/my-username/my-dataset/.gitattributes', 'datasets/my-username/my-dataset/README.md', 'datasets/my-username/my-dataset/data.json']

    >>> # Read/write files
    >>> with fs.open("my-username/my-src/pytorch_model.bin") as f:
    ...     data = f.read()
    >>> with fs.open("my-username/my-src/pytorch_model.bin", "wb") as f:
    ...     f.write(data)
    ```
    """
