...
class Repository:
    ...
    The aim is to facilitate interacting with huggingface.co hosted src or
    ...
    def __init__(
        ...
        Args:
            ...
            repo_type (`str`, *optional*):
                To set when cloning a repo from a repo_id. Default is src.
    ...
    def commit(
        ...
        >>> src = torch.nn.Transformer()
        >>> with Repository(
        ...     "torch-src",
        ...     clone_from="<user>/torch-src",
        ...     token=True,
        >>> ).commit("My cool src :)"):
        ...     torch.save(src.state_dict(), "src.pt")
        ```
