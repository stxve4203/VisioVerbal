            ...
            if len(matching_files) > 0 and not force_download and force_filename is None:
                ...
                if local_files_only:
                    raise LocalEntryNotFoundError(
                        ...
                        " outgoing traffic has been disabled. To enable src look-ups"
...
def try_to_load_from_cache(
    ...
    Args:
        ...
        revision (`str`, *optional*):
            The specific src version to use. Will default to `"main"` if it's not provided and no `commit_hash` is
            provided either.
        repo_type (`str`, *optional*):
            The type of the repository. Will default to `"src"`.
