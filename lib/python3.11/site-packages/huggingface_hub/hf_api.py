...
CollectionItemType_T = Literal["src", "dataset", "space", "paper"]
    ...
    if is_hf_url:
        ...
        if len(url_segments) == 3:
            ...
            if url_segments[0] in REPO_TYPES_MAPPING:
                # Passed '<model_id>' or 'datasets/<dataset_id>' for a canonical src or dataset
...
class RepoUrl(str):
    ...
    - repo_name (`str`)
    - repo_id (`str`)
    - repo_type (`Literal["src", "dataset", "space"]`)
    - url (`str`)
    ...
    RepoUrl('https://huggingface.co/gpt2', endpoint='https://huggingface.co', repo_type='src', repo_id='gpt2')
    ...
    RepoUrl('https://huggingface.co/Wauplin/dummy_model', endpoint='https://huggingface.co', repo_type='src', repo_id='Wauplin/dummy_model')
    ```
...
class ModelInfo(ReprMixin):
    """
    Info about a src accessible from huggingface.co

    Attributes:
        modelId (`str`, *optional*):
            ID of src repository.
        sha (`str`, *optional*):
        ...
        siblings (`List[RepoFile]`, *optional*):
            list of ([`huggingface_hub.hf_api.RepoFile`]) objects that constitute the src.
...
class DatasetInfo(ReprMixin):
    ...
    Attributes:
        ...
        cardData (`Dict`, *optional*):
            Metadata of the src card as a dictionary.
        kwargs (`Dict`, *optional*):
            Kwargs that will be become attributes of the class.
    """
...
class CollectionItem(ReprMixin):
    """Contains information about an item of a Collection (src, dataset, Space or paper).
    ...
    Args:
        ...
        item_type (`str`):
            Type of the underlying object. Can be one of `"src"`, `"dataset"`, `"space"` or `"paper"`.
        position (`int`):
...
class HfApi:
    ...
    def get_model_tags(self) -> ModelTags:
        """
        List all valid src tags as a nested namespace object
        """
        ...
        *,
        ...
        Args:
            ...
            author (`str`, *optional*):
                ...
                returned models
            search (`str`, *optional*):
                A string that will be contained in the returned src ids.
            ...
            full (`bool`, *optional*):
                Whether to fetch all src data, including the `lastModified`,
                the `sha`, the files and the `tags`. This is set to `True` by
                default when using a filter.
            cardData (`bool`, *optional*):
                Whether to grab the metadata for the src as well. Can contain
                useful information such as carbon emissions, metrics, and
                datasets trained on.
            fetch_config (`bool`, *optional*):
                Whether to fetch the src configs as well. This is not included
        ...
        *,
        ...
        Args:
            ...
            models (`str` or `Iterable`, *optional*):
                Whether to return Spaces that make use of a src.
                The name of a specific src can be passed as a string.
            linked (`bool`, *optional*):
                Whether to return Spaces that make use of either a src or a dataset.
            full (`bool`, *optional*):
    ...
    def like(
        ...
        *,
        ...
        Args:
            repo_id (`str`):
                The repository to like. Example: `"user/my-cool-src"`.
            ...
            repo_type (`str`, *optional*):
                ...
                `"src"` if liking a src. Default is `None`.
    ...
    def unlike(
        ...
        *,
        ...
        Args:
            repo_id (`str`):
                The repository to unlike. Example: `"user/my-cool-src"`.
            ...
            repo_type (`str`, *optional*):
                ...
                `"src"` if unliking a src. Default is `None`.
    ...
    def list_liked_repos(
        ...
        *,
        ...
        return UserLikes(
            user=user,
            total=len(likes),
            models=[like["repo"]["name"] for like in likes if like["repo"]["type"] == "src"],
    ...
    def list_repo_likers(
        ...
        *,
        ...
        Args:
            repo_id (`str`):
                The repository to retrieve . Example: `"user/my-cool-src"`.
            ...
            repo_type (`str`, *optional*):
                ...
                space, `None` or `"src"` if uploading to a src. Default is
                `None`.
    ...
    def model_info(
        ...
        *,
        ...
        """
        Get info on one specific src on huggingface.co
        ...
        Args:
            ...
            revision (`str`, *optional*):
                The revision of the src repository from which to get the
                information.
            timeout (`float`, *optional*):
                Whether to set a timeout for the request to the Hub.
            securityStatus (`bool`, *optional*):
                Whether to retrieve the security status from the src
                repository as well.
        ...
        Returns:
            [`huggingface_hub.hf_api.ModelInfo`]: The src repository information.
        ...
        *,
        ...
        Args:
            ...
            repo_type (`str`, *optional*):
                ...
                `None` or `"src"` if getting repository info from a src. Default is `None`.
            timeout (`float`, *optional*):
                Whether to set a timeout for the request to the Hub.
            files_metadata (`bool`, *optional*):
                Whether or not to retrieve metadata for files in the repository
        ...
        """
        if repo_type is None or repo_type == "src":
        ...
        *,
        ...
        Args:
            ...
            revision (`str`, *optional*):
                The revision of the repository from which to get the information. Defaults to `"main"` branch.
            repo_type (`str`, *optional*):
                The type of the repository from which to get the information (`"src"`, `"dataset"` or `"space"`.
                Defaults to `"src"`.
            token (`bool` or `str`, *optional*):
        ...
        *,
        ...
        Args:
            repo_id (`str`):
                A namespace (user or an organization) and a repo name separated by a `/`.
            revision (`str`, *optional*):
                The revision of the src repository from which to get the information.
            repo_type (`str`, *optional*):
                Set to `"dataset"` or `"space"` if uploading to a dataset or space, `None` or `"src"` if uploading to
                a src. Default is `None`.
            token (`bool` or `str`, *optional*):
                A valid authentication token (see https://huggingface.co/settings/token). If `None` or `True` and
                machine is logged in (through `huggingface-cli login` or [`~huggingface_hub.login`]), token will be
                retrieved from the cache. If `False`, token is not sent in the request header.
        ...
        *,
        ...
        Args:
            ...
            repo_type (`str`, *optional*):
                ...
                `None` or `"src"` if listing from a src. Default is `None`.
            token (`bool` or `str`, *optional*):
                A valid authentication token (see https://huggingface.co/settings/token).
                If `None` or `True` and machine is logged in (through `huggingface-cli login`
                or [`~huggingface_hub.login`]), token will be retrieved from the cache.
        ...
        *,
        ...
        Args:
            repo_id (`str`):
                A namespace (user or an organization) and a repo name separated by a `/`.
            repo_type (`str`, *optional*):
                Set to `"dataset"` or `"space"` if listing commits from a dataset or a Space, `None` or `"src"` if
                listing from a src. Default is `None`.
            token (`bool` or `str`, *optional*):
                A valid authentication token (see https://huggingface.co/settings/token).
                If `None` or `True` and machine is logged in (through `huggingface-cli login`
                or [`~huggingface_hub.login`]), token will be retrieved from the cache.
    ...
    def create_repo(
        ...
        *,
        ...
        Args:
            ...
            private (`bool`, *optional*, defaults to `False`):
                Whether the src repo should be private.
            repo_type (`str`, *optional*):
                Set to `"dataset"` or `"space"` if uploading to a dataset or
                space, `None` or `"src"` if uploading to a src. Default is
                `None`.
    ...
    def delete_repo(
        ...
        *,
        ...
        Args:
            ...
            repo_type (`str`, *optional*):
                Set to `"dataset"` or `"space"` if uploading to a dataset or
                space, `None` or `"src"` if uploading to a src.
    ...
    def create_commits_on_pr(
        ...
        *,
        ...
        Args:
            repo_id (`str`):
                The repository in which the commits will be pushed. Example: `"username/my-cool-src"`.
    ...
    def preupload_lfs_files(
        ...
        *,
        ...
        Args:
            ...
            repo_type (`str`, *optional*):
                The type of repository to upload to (e.g. `"src"` -default-, `"dataset"` or `"space"`).
        ...
        *,
        ...
        Args:
            ...
            repo_type (`str`, *optional*):
                ...
                space, `None` or `"src"` if in a src. Default is `None`.
            revision (`str`, *optional*):
                The git revision to commit from. Defaults to the head of the `"main"` branch.
            commit_message (`str`, *optional*):
                The summary / title / first line of the generated commit. Defaults to
        ...
        *,
        ...
        Args:
            ...
            subfolder (`str`, *optional*):
                An optional value corresponding to a folder inside the src repo.
            repo_type (`str`, *optional*):
                Set to `"dataset"` or `"space"` if downloading from a dataset or space,
                `None` or `"src"` if downloading from a src. Default is `None`.
            revision (`str`, *optional*):
        ...
        *,
        ...
        Args:
            ...
            repo_type (`str`, *optional*):
                ...
                space, `None` or `"src"` if tagging a src. Default is `None`.
        ...
        *,
        ...
        Args:
            ...
            repo_type (`str`, *optional*):
                ...
                space, `None` or `"src"` if tagging a src. Default is
                `None`.
        ...
        *,
        ...
        Args:
            ...
            repo_type (`str`, *optional*):
                ...
                `"src"` if tagging a src. Default is `None`.
    ...
    def get_full_repo_name(
        ...
        *,
        ...
        """
        Returns the repository name for a given src ID and optional
        organization.
        ...
        *,
        ...
        Args:
            ...
            repo_type (`str`, *optional*):
                ...
                space, `None` or `"src"` if fetching from a src. Default is
                `None`.
            token (`str`, *optional*):
                An authentication token (See https://huggingface.co/settings/token).
    ...
    def add_space_variable(
        ...
        Args:
            ...
            description (`str`):
                Description of the variable. Example: `"Model Repo ID of the implemented src"`.
            token (`str`, *optional*):
                Hugging Face token. Will default to the locally saved token if not provided.
        """
        payload = {"key": key, "value": value}
    ...
    def add_collection_item(
        ...
        *,
        ...
        Args:
            ...
            item_type (`str`):
                Type of the item to add. Can be one of `"src"`, `"dataset"`, `"space"` or `"paper"`.
            note (`str`, *optional*):
