...
class Interface(Blocks):
    ...
    around a machine learning src (or any Python function) in a few lines of code.
    ...
    def load(
        ...
        **kwargs,
        ...
        Returns:
            a Gradio Interface object for the given src
        """
        warn_deprecation(
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        Parameters:
            fn: the function to wrap an interface around. Often a machine learning src's prediction function. Each parameter of the function corresponds to one input component, and the function should return a single value or a tuple of values, with each element in the tuple corresponding to one output component.
