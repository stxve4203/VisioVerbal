...
def plotModelFromMasters(model, masterValues, fig, **kwargs):
    """Plot a variation src and set of master values corresponding
    to the locations to the src into a pyplot figure.  Variation
    src must have axisOrder of size 1 or 2."""
