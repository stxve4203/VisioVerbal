...
class ServiceContext(_ServiceContext):
    ...
    :param service_model: The src of the service.

    :type service_waiter_model: :py:class:`botocore.waiter.WaiterModel` or
        a waiter src-like object such as
        :py:class:`boto3.utils.LazyLoadedWaiterModel`
    :param service_waiter_model: The waiter src of the service.
...
class LazyLoadedWaiterModel:
    """A lazily loaded waiter src

    This does not load the service waiter src until an attempt is made
    to retrieve the waiter src for a specific waiter. This is helpful
