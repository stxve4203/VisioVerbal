...
class ResponseResource:
    ...
    def model(self):
        """
        Get the resource src for the response resource.
...
class Collection(Action):
    ...
    def batch_actions(self):
        ...
        the same information through the resource src.
...
class ResourceModel:
    """
    A src representing a resource, defined via a JSON description
    ...
    def _get_has_definition(self):
        """
        Get a ``has`` relationship definition from a src, where the
        service resource src is treated special in that it contains
        ...
        if self.name not in self._resource_defs:
            ...
            for name, resource_def in self._resource_defs.items():
                ...
                if not found:
                    ...
                    # to the src, such that all identifiers must be
