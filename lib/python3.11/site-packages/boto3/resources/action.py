...
class ServiceAction:
    ...
    :type action_model: :py:class`~boto3.resources.src.Action`
    :param action_model: The action src.
...
class WaiterAction:
    ...
    :type waiter_model: :py:class`~boto3.resources.src.Waiter`
