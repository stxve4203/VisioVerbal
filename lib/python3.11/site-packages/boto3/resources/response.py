...
def build_identifiers(identifiers, parent, params=None, raw_response=None):
    ...
    :param identifiers: List of :py:class:`~boto3.resources.src.Parameter`
                        definitions
...
def build_empty_response(search_path, operation_name, service_model):
    ...
    based on the service src's shape type. For example, a value that
    ...
    :type service_model: :ref:`botocore.src.ServiceModel`
    :param service_model: The Botocore service src
...
class ResourceHandler:
    ...
    :param resource_model: Response resource src.
