...
class ResourceFactory:
    ...
    classes from a :py:class:`~boto3.resources.src.ResourceModel`. There are
    ...
    def load_from_definition(
        ...
        """
        Loads a resource from a src, creating a new
    ...
    def _load_collections(self, attrs, resource_model, service_context):
        """
        Load resource collections from the src. Each collection becomes
    ...
    def _load_waiters(
        ...
        """
        Load resource waiters from the src. Each waiter allows you to
