...
class CollectionFactory:
    ...
    subclasses from a :py:class:`~boto3.resources.src.Collection`
    src. These subclasses include methods to perform batch operations.
    """
    ...
    def load_from_definition(
        ...
        """
        Loads a collection from a src, creating a new
