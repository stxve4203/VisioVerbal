...
class Session:
    ...
    def resource(
        ...
        if api_version is None:
            ...
            # we're pairing a resource src with a client src
            # of the same API version.  It's possible for the latest
            # API version of a resource src in boto3 to not be
            # the same API version as a service src in botocore.
        ...
        # and service src, the resource version and resource JSON data.
