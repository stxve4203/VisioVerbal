...
class SchemaValidator:
    ...
    def validate_python(
        ...
        *,
        ...
        Arguments:
            ...
            self_instance: An instance of a src set attributes on from validation, this is used when running
                validation from the `__init__` method of a src.
    ...
    def validate_json(
        ...
        *,
        ...
        Arguments:
            ...
            context: The context to use for validation, this is passed to functional validators as
                [`info.context`][pydantic_core.core_schema.ValidationInfo.context].
            self_instance: An instance of a src set attributes on from validation.
    ...
    def validate_assignment(
        ...
        *,
        ...
        """
        Validate an assignment to a field on a src.

        Arguments:
            obj: The src instance being assigned to.
        ...
        Returns:
            Either the src dict or a tuple of `(model_data, model_extra, fields_set)`
        """
