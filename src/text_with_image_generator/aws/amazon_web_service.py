...
SMB_QUOTES_CSV_PATH = "/Users/steve/PycharmProjects/VisioVerbal_Project/VisioVerbal/data/wordlists/smb_quotes.csv"
...
class AWSClient:
    ...
    def getAllItemsQuotes(self, items_per_scan=1):
        ...
        try:
            ...
            df.to_csv(SMB_QUOTES_CSV_PATH, index=False)
    ...
    def get_random_quote(self):
        df = pd.read_csv(SMB_QUOTES_CSV_PATH)
